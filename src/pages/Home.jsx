    ...
    <div className="min-h-screen bg-zinc-800 text-zinc-100">
      ...
      {hasSearch && (
        <section className="max-w-6xl mx-auto px-4 pb-20">
          {/* concert */}
          <div>
            <h2 className="text-2xl font-bold mb-6">Concerts</h2>
          ...
          {[
            {
              title: "Easy Booking",
              description:
                "Book concert tickets in seconds with a smooth experience.",
            },
            {
              title: "Live Events",
              description:
                "Discover exciting upcoming concerts and performances.",
            },
            {
              title: "Trusted Venues",
              description: "Explore events from reliable and popular venues.",
            },
          ].map((item) => (
            <div
              key={item.title}
            ...
            >
              <h3 className="text-[#1B5E4A] font-medium text-lg text-center">
                {item.title}
              </h3>
