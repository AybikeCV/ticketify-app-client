      ...
      <div className="w-full max-w-md bg-zinc-900 border border-zinc-800 rounded-2xl p-8 shadow-2xl">
        <div className="mb-8">
          ...
          <p className="text-center text-zinc-500 mt-3">
            Create an account to book and manage your tickets and enjoy
            concerts!
          </p>
        </div>

        <h1 className="w-full bg-zinc-950 border border-zinc-800 px-4 py-3 text-center text-zinc-100 outline-none font-semibold mt-4 transition focus:border-[#1B5E4A]">
          Signup Form
        </h1>
        <br />
        <form className="space-y-5" onSubmit={handleSignup}>
          ...
          <button
            type="submit"
            className="w-full bg-[#1B5E4A] hover:bg-[#164A3A] transition text-white py-3 rounded-lg font-semibold mt-4"
          >
            Signup
          </button>
