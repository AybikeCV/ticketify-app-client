...
function VenueCard({ venue }) {
  ...
  return (
    <div className="bg-zinc-900 border border-zinc-800 rounded-xl overflow-hidden hover:border-[#1B5E4A]/40 transition">
      ...
      <div className="p-5">
        <h2 className="text-xl font-semibold text-zinc-100">{venue.name}</h2>

        <p className="text-zinc-400 mt-2">{venue.city}</p>

        <p className="text-zinc-500 text-sm mt-3">Capacity: {venue.capacity}</p>
